...
export const metadata: Metadata = {
  title: "Terms and Conditions — Peldot",
  description: "Peldot Terms and Conditions.",
};
  ...
  return (
    <LegalPage
      ...
      sections={[
        ...
        { heading: "Integrations", body: "Addresses third-party system connections (CRM, Pingr, Teamspace). We provide setup instructions but assume no responsibility for integration failures caused by client systems or external factors." },
