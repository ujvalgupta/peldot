...
export const metadata: Metadata = {
  title: "Data Policy — WhiteWhale",
  description: "WhiteWhale Data Policy.",
};
  ...
  return (
    <LegalPage
      ...
      sections={[
        ...
        { heading: "Right to Opt Out and Data Removal", body: "Individuals can request access, correction, deletion, or exclusion of their data by contacting hello@getwhitewhale.com. We commit to responding within 15 days in accordance with GDPR Article 12." },
        ...
        { heading: "Contact and Complaints", body: "Users can contact hello@getwhitewhale.com with questions or to report violations." },
      ]}
    />
  );
}
