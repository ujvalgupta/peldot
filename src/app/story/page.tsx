...
const LETTER = [
  ...
  "That’s when WhiteWhale was born.",
  "Today, WhiteWhale is the culmination of everything we’ve learned: from hedge funds to high-velocity sales, from spreadsheets to scalable software.",
];
      ...
      <Reveal as="section" className="mx-auto max-w-[720px] px-5 pb-16 sm:px-8 sm:pb-24">
        <div className="rounded-2xl border border-hairline bg-white p-8 sm:p-12">
          ...
          <div className="mt-6 space-y-5 text-[17px] leading-[1.7] text-[#3b3b3b]">
            ...
            <p className="text-[#0a0a0a]">Sincerely,<br />Noah &amp; Jack</p>
          </div>
        </div>
      </Reveal>
